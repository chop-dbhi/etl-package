package edu.chop.cbmi.etl.library.statistics.statsd;
...
public class StatsdClient {
    ...
    public boolean count(String key, long count) {
        return count(key, count, 1.0);
    }

    public boolean count(String key, long count, double sampleRate) {
        String stat = String.format(Locale.ENGLISH, "%s:%s|c", key, count);
